...
<head>
  ...
  <script
    src="//apps.8thwall.com/xrweb?appKey=sATgykyfgF8al3BIAM87ij3MauRCDA2Blkwm0GIUSZP38qCvZOu1RpSRuciMqsieVOZQcF"></script>
...
<body>
  ...
  <a-scene
    ...
    <a-assets>
      <a-asset-item id="frame-glb" src="blender.glb"></a-asset-item>
    </a-assets>
    ...
    <a-entity image-target>
      ...
      <a-entity id="frame" position="1.5 0 -5" scale=".50 .50 .50" rotation="0 80 0" gltf-model="#frame-glb"></a-entity>
